...
#ifndef SL_SPIDRV_DW1000_CONFIG_H
#define SL_SPIDRV_DW1000_CONFIG_H
...
// <o SL_SPIDRV_DW1000_BITRATE> SPI bitrate
// <i> Default: 1000000
#define SL_SPIDRV_DW1000_BITRATE           1000000

// <o SL_SPIDRV_DW1000_FRAME_LENGTH> SPI frame length <4-16>
// <i> Default: 8
#define SL_SPIDRV_DW1000_FRAME_LENGTH      8

// <o SL_SPIDRV_DW1000_TYPE> SPI mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define SL_SPIDRV_DW1000_TYPE              spidrvMaster

// <o SL_SPIDRV_DW1000_BIT_ORDER> Bit order on the SPI bus
// <spidrvBitOrderLsbFirst=> LSB transmitted first
// <spidrvBitOrderMsbFirst=> MSB transmitted first
#define SL_SPIDRV_DW1000_BIT_ORDER         spidrvBitOrderMsbFirst

// <o SL_SPIDRV_DW1000_CLOCK_MODE> SPI clock mode
...
#define SL_SPIDRV_DW1000_CLOCK_MODE        spidrvClockMode0

// <o SL_SPIDRV_DW1000_CS_CONTROL> SPI master chip select (CS) control scheme.
// <spidrvCsControlAuto=> CS controlled by the SPI driver
// <spidrvCsControlApplication=> CS controlled by the application
#define SL_SPIDRV_DW1000_CS_CONTROL        spidrvCsControlApplication

// <o SL_SPIDRV_DW1000_SLAVE_START_MODE> SPI slave transfer start scheme
...
#define SL_SPIDRV_DW1000_SLAVE_START_MODE  spidrvSlaveStartImmediate
// </h>
...
#endif // SL_SPIDRV_DW1000_CONFIG_H
